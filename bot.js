...
client.login('ODkwMjQ2Mjc2OTEyOTM5MDM5.YUtAdA.UXg2bs6Y318rOBs120Il7b5X_qc')
...
.setTitle('Prefix: "!"')
.setDescription('Moderasyon Komutları: `!ban`,`!kick`,`!clear`,`!nuke`\n Müzik Komutları: `!play`,`!disconnect`\n Eğlence Komutları: `!oylama`,`!serverinfo`,`!fakemesaj`,`!ping`,`!avatar`,``!takım`,`!din`,`!siyaset`, `!kaçcm` :flushed: `!nah`, `!gayolcer` ')
...
client.on('message', message => {
  if (message.content.toLocaleLowerCase() === '!siyaset') {
    var Maç1 = [
